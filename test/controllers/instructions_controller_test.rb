...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { content: @instruction.content, name: @instruction.name, subject_id: @instruction.subject_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { content: @instruction.content, name: @instruction.name, subject_id: @instruction.subject_id } }
